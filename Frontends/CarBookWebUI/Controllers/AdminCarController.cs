...
namespace CarBookWebUI.Controllers
{
    public class AdminCarController : Controller
    {
        ...
        public async Task<IActionResult> CreateCar(CreateCarDto createCarDto)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            //Ekleme ve silmede serialize yapilir.
        ...
        public async Task<IActionResult> UpdateCar(int id)
        {
            ...
            var responseMessage1 = await client.GetAsync("https://localhost:7164/api/Brands");
            ...
            var resposenMessage = await client.GetAsync($"https://localhost:7164/api/Cars/{id}");
